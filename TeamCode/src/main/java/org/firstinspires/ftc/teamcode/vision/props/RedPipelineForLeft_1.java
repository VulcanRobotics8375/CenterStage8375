...
public class RedPipelineForLeft extends OpenCvPipeline {

    Telemetry telemetry;

    public RedPipelineForLeft(Telemetry t) {
        telemetry = t;
    ...
    Rect leftRect = new Rect(240, 270, 200, 100); // define our regions of interest (where the algorithm is focusing on) as rectangles
    Rect midRect = new Rect(610, 240, 530, 100);
