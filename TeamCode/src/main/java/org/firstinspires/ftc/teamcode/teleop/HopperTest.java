...
//
//@TeleOp(name = "HopperTest")
//public class HopperTest extends OpModePipeline {
...
//
//        subsystems.hopper.testHopperInternalServos(gamepad1.left_stick_x, gamepad1.right_stick_x);
